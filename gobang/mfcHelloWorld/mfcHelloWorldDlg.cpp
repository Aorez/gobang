...
CMfcHelloWorldDlg::CMfcHelloWorldDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CMfcHelloWorldDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMfcHelloWorldDlg)
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMfcHelloWorldDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CMfcHelloWorldDlg, CDialog)
	//{{AFX_MSG_MAP(CMfcHelloWorldDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
